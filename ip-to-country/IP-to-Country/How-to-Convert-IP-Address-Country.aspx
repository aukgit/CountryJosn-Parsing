...
<body>
    ...
    <div style="text-align: left">
        ...
        <asp:DetailsView ID="DetailsView1" runat="server" BackColor="#DEBA84" 
            ...
            CellSpacing="2" DataSourceID="SqlDataSource1" Height="50px" Width="309px" AutoGenerateRows="False" DataKeyNames="ID" EnableModelValidation="True">
            <Fields>
                <asp:BoundField DataField="ID" HeaderText="ID" InsertVisible="False" ReadOnly="True" SortExpression="ID" />
                <asp:BoundField DataField="BeginingIP" HeaderText="BeginingIP" SortExpression="BeginingIP" />
                <asp:BoundField DataField="EndingIP" HeaderText="EndingIP" SortExpression="EndingIP" />
                <asp:BoundField DataField="TwoCountryCode" HeaderText="TwoCountryCode" SortExpression="TwoCountryCode" />
                <asp:BoundField DataField="ThreeCountryCode" HeaderText="ThreeCountryCode" SortExpression="ThreeCountryCode" />
